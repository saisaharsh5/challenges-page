...
-- Drop existing policies if they exist, then create new ones for static_content
...
-- Create tryhackme_rooms table (using text instead of enum for difficulty)
...
-- Drop existing policies if they exist, then create new ones for tryhackme_rooms
...
-- Drop existing policies if they exist, then create new ones for hackthebox_machines
...
-- Drop existing policies if they exist, then create new ones for ctf_challenges
